...
- ./specifications/App_Functionality_Full_Stack.md
...
- Set status to "tested" in ./specifications/App_Functionality_Full_Stack.md after all tests pass successfully for the implemented function.- 
